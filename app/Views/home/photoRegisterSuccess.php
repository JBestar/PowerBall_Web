...
<body>
	<div class="wrap">
		<div class="msg">
			...
			<div class="small">메인 화면을 갱신해서 방금 등록한 포토를 즉시 확인할 수 있게 해드립니다.</div>
	...
	<script type="text/javascript">
		// 부모(메인)에서 포토 탭이 보이도록: 플래그 저장 + 새로고침 + 창 닫기
		try {
			if (window.opener && !window.opener.closed) {
				try { window.opener.sessionStorage.setItem('forcePhotoTab', '1'); } catch (e) {}
